...
(defvar logview-std-submodes
  '(("SLF4J" . ((format  . "TIMESTAMP [THREAD] LEVEL NAME -")
    ...
    ("Monolog" . ((format  . "[TIMESTAMP] NAME[THREAD].LEVEL: MESSAGE")
                  (levels  . "RFC 5424")
                  (aliases . ("PHP" "PSR-3"))))
    ;; Should add a notion of PROCESS
    ("Android" . ((format  . "TIMESTAMP <<RX:IGNORED:[0-9]+>> <<RX:THREAD:[0-9]+>> LEVEL NAME:")
                  (levels  . "Android")
                  (aliases . ("logcat")))))
...
(defface logview-error-entry
  '((t :background "brightyellow" :bold t))
